...
CBaseShader::CBaseShader(const char* stShaderPath)
{
	...
	sys_log("CBaseShader::CBaseShader ShaderName : %s", GetName().c_str());
	sys_log("CBaseShader::CBaseShader ShaderType : %s", GetTypeName().c_str());
	sys_log("CBaseShader::CBaseShader ShaderID : %d", GetShaderID());
	sys_log("CBaseShader::CBaseShader ShaderActualType : %s", GetType().m_stName.c_str());
#endif
}
