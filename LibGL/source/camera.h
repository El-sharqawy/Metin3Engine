...
public:
	...
	bool AddCamera(GLubyte CamNum);
	bool RemoveCamera(GLubyte CamNum);
	...
	bool IsCurrentCamera(const GLubyte CamNum);

private:
	typedef std::map<GLubyte, CCamera*> TCameraMap;
