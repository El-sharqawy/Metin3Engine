...
void SBoundingBox::ComputeFromMesh(const aiMesh* mesh)
{
	Reset();
...
SBoundingBox SBoundingBox::Transform(const CMatrix4Df& mat)
{
	SetCorners();
...
void SBoundingBox::Draw(bool hIsSelectedObject)
{
