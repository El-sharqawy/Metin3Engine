...
/* convert World Coords - Mouse pos to Terrain Coords */
void Vec3Lerp(SVector3Df& v3CurPos, const SVector3Df& v3Start, const SVector3Df& v3End, float t)
{
    v3CurPos = v3Start + t * (v3End - v3Start);
}
