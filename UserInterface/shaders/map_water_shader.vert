...
void main()
{
    ...
    v3NewPos.y += GerstnerWave(normalize(vec2(0.0, 1.0)), 12.0, 0.06, u_fMoveFactor * 1.2);
    v3NewPos.y += GerstnerWave(normalize(vec2(-1.0, 0.7)), 22.0, 0.07, u_fMoveFactor * 0.8);
